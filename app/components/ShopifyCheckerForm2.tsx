...
import { Search, Globe, Loader2, Sparkles, Zap } from 'lucide-react';
        ...
        <div className="relative">
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button
                ...
                icon={loading ? <Loader2 className="h-5 w-5 animate-spin" /> : <Zap className="h-5 w-5" />}
              >
          ...
          >
            {['Fast', 'Accurate', 'Secure'].map((feature, index) => (
              ...
              >
                <motion.div
                  className="h-1.5 w-1.5 bg-[#008060] rounded-full"
